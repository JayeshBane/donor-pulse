...
const HomeContent = dynamic(() => Promise.resolve(HomePageContent), { ssr: false })
...
function HomePageContent() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-12">
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden text-center hover:shadow-lg transition-shadow">
          <div className="p-6">
            ...
            <div className="text-left bg-gray-50 p-3 rounded-lg">
              ...
              <p className="text-sm font-mono">UPDATE - Get update link via SMS</p>
      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden border-blue-200">
        <div className="p-6">
          <div className="text-center">
            ...
            <div className="grid md:grid-cols-3 gap-6 text-left">
              <div className="text-center">
                ...
                <div className="font-bold text-blue-700 mb-2 text-center">Register</div>
                <p className="text-gray-700 text-center">Create your donor profile with medical info and location.</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold">2</span>
                </div>
                <div className="font-bold text-blue-700 mb-2 text-center">Get SMS</div>
                <p className="text-gray-700 text-center">Receive welcome SMS with available commands.</p>
              </div>
              <div className="text-center">
                <div className="w-12 h-12 bg-blue-600 rounded-full flex items-center justify-center mx-auto mb-3">
                  <span className="text-white font-bold">3</span>
                </div>
                <div className="font-bold text-blue-700 mb-2 text-center">Respond</div>
                <p className="text-gray-700 text-center">Reply to alerts when hospitals need your blood type.</p>
              </div>
            </div>
          </div>
        </div>
